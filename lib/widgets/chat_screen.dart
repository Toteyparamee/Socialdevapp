...
class _ChatRoomScreenState extends State<ChatRoomScreen>
  ...
  // ถ้า widget.toUserId ไม่มี ให้ดึง otherUser จาก room ปัจจุบัน
  String? _resolvedToUserId() {
    if (widget.toUserId != null && widget.toUserId!.isNotEmpty) {
      return widget.toUserId;
    }
    ...
    for (final room in rooms) {
      if (room.id == _currentRoomId) {
        return room.userA == myId ? room.userB : room.userA;
      }
    }
    return null;
  }
